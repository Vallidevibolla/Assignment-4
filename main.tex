...
Given 
\myvec{1&-2}\vec{x}=4\\
Let '\vec{y}' be the solution then equation be 
\begin{equation} \label{eq:1}
\boxed{\vec{y}=\myvec{1&-2}\vec{x}}
\end{equation}
\text{Substitute}
\begin{align}
 \text{\vec{x}=\myvec{0\\2}in \eqref{eq:1}}\\
          \vec{y}=\myvec{1&-2}\myvec{0\\2}\\
          \boxed{\vec{y}=-4}
\end{align}
\text{Substitute }
\begin{align}
\text{\vec{x}=\myvec{4\\0}in \eqref{eq:1}}\\
          \vec{y}=\myvec{1&-2}\myvec{4\\0}\\
          \boxed{\vec{y}=4}
\end{align}
\text{Substitute}
\begin{align}
 \text{\vec{x}=\myvec{2\\0}in \eqref{eq:1}}\\
          \vec{y}=\myvec{1&-2}\myvec{2\\0}\\
          \boxed{\vec{y}=2}   
\end{align}
\text{Substitute}
\begin{align}
\text{\vec{x}=\myvec{\sqrt{2}\\4\sqrt{2}}in \eqref{eq:1}}\\
          \vec{y}=\myvec{1&-2}\myvec{\sqrt{2}\\4\sqrt{2}}\\
          \boxed{\vec{y}=-7\sqrt{2}}    
\end{align}
\text{Substitute} 
\begin{align}
\text{\vec{x}=\myvec{1\\1}in \eqref{eq:1}}\\
          \vec{y}=\myvec{1&-2}\myvec{1\\1}\\
          \boxed{\vec{y}=-1}
\end{align}
$\therefore$ 
\vec{x}=\myvec{4\\0} is the solution of the equation \myvec{1&-2}\vec{x}=4
